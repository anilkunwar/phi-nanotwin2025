...
# ============================================================================
# ERROR HANDLING DECORATOR (from CODE 1)
# ============================================================================
...
# ============================================================================
# METADATA MANAGEMENT (from CODE 1)
# ============================================================================
...
# ============================================================================
# ENHANCED COLORMAP LIBRARY (50+ options, from CODE 1)
# ============================================================================
COLORMAPS = {
    # Sequential (1)
    'viridis': 'viridis',
...
# ============================================================================
# ENHANCED SIMULATION DATABASE (from CODE 1)
# ============================================================================
...
# ============================================================================
# HELPER FUNCTION: Build filename-friendly simulation name (from CODE 1)
# ============================================================================
@handle_errors
...
# ============================================================================
# NUMBA-COMPATIBLE FUNCTIONS (unchanged, but decorated)
# ============================================================================
@njit(parallel=True)
...
# ============================================================================
# MAIN SOLVER CLASS (unchanged evolution logic, but now with @handle_errors)
# ============================================================================
    ...
    def step(self, applied_stress):
        ...
        try:
            ...
            return {
                ...
                'sigma_eq': zeros, 'sigma_xx': zeros, 'sigma_yy': zeros, 'sigma_xy': zeros,
...
def main():
    ...
    <strong>Advanced Physics + Enhanced Post-Processing (CODE 1 features integrated):</strong><br>
    ...
    with st.expander("🐛 Debug Information", expanded=False):
        ...
        if all_sims:
            ...
            for k, v in all_sims.items():
                ...
                mem = 0
                for frame in history:
                    for fname in ['phi', 'eta1', 'eta2', 'sigma_eq', 'h']:
                        if fname in frame:
