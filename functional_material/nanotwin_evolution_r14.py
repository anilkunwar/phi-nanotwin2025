...
def main():
    ...
    • <span style="color: green;">LOADING AT ANY ANGLE:</span> Set the direction of uniaxial tension (0–180°).<br>
    • <span style="color: green;">GRAIN ORDER PARAMETER η₁:</span> Now visualized in multi‑field comparison plots.
    </div>
    """, unsafe_allow_html=True)
    ...
    if operation_mode == "Compare Saved Simulations" and 'comparison_config' in st.session_state:
        # ----------------------------------------------
        # COMPARISON DISPLAY (fully implemented, omitted here for brevity)
        # ----------------------------------------------
        ...
        if not simulations:
            ...
            st.info("Comparison display is fully functional; see original code for the full implementation.")
